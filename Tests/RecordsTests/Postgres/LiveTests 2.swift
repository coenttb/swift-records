...
//        try await RecordsTestSupport.assertQuery(Reminder.all) {
//            """
...
//    }
//    
//    @Test func remindersListWithReminderCount() async throws {
//        try await assertQuery(
//            RemindersList
//                .group(by: \.id)
...
//    }
//    
//    //    @Test func remindersWithTags() async throws {
//    //      try await assertQuery(
//    //        Reminder
//    //          .group(by: \.id)
...
//                )
//            )
//            try await SyncUp.insert().execute(db)
//            
//            let firstSyncUp = try await SyncUp.all.select(\.createdAt).fetchOne(db)
//            #expect(
//                try #require(firstSyncUp).timeIntervalSinceNow < 1
//            )
//            
//            let syncUps = try await SyncUp.all.fetchAll(db)
//            #expect(
//                try #require(syncUps.first).id == 1
//            )
//        }
//    }
//    
