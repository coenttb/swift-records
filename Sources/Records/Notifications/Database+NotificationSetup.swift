...
extension Database.Connection.`Protocol` {
    ...
    func createNotificationTriggerFunction<On: Table>(
        ...
        print("📢 Creating notification trigger function '\(functionName.rawValue)' for channel '\(channel.rawValue)'")
        do {
    ...
    func createNotificationTrigger<On: Table>(
        ...
        print("📢 Creating notification trigger '\(triggerName.rawValue)' on table '\(On.tableName)'")
        do {
            try await execute(sql)
    ...
    func dropNotificationTrigger<On: Table>(
        ...
        print("📢 Dropping notification trigger '\(triggerName.rawValue)' from table '\(On.tableName)'")
        do {
            try await execute(sql)
